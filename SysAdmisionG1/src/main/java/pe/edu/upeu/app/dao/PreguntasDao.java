...
public class PreguntasDao {
    ...
    public List<PreguntasTO> listarTodo() {
        ...
        String sql = "SELECT preguntas * "
                + "FROM preguntas, area_periodo, banco_preguntas "
                + "WHERE area_periodo.id_area_periodo = preguntas.id_area_periodo and preguntas.id_bp = banco_preguntas.id_banco_bp";
        try {
            ps = connection.prepareStatement(sql);
            rs = ps.executeQuery();
            while (rs.next()) {
    ...
    public void listarPregunta(List<PreguntasTO> lista) {
        System.out.println("Pregunta\t\t\tResultado");
        for (PreguntasTO p : lista) {
            System.out.println(p.getBancoPreguntas() + "\t\t" + p.getPregunta() + "\t\t\t");
        }
    }
    ...
    public List<ModeloDataAutocomplet> listAutoCompletAreaPeriodo(String filter) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    public List<ModeloDataAutocomplet> listAutoCompletBancoPreguntas(String filter) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
